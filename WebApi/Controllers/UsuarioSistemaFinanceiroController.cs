...
namespace WebApi.Controllers
{
    ...
    public class UsuarioSistemaFinanceiroController : ControllerBase
    {
        ...
        private readonly IUsuarioSistemaFinanceiroService _IUsuarioSistemaFinanceiroServico;
        ...
        {
            return await _InterfaceUsuarioSistemaFinanceiro.ListarUsuariosSistemaFinanceiro(idSistema);
        }
